...
class BimbinganKelompokService
{
    ...
    public function create(array $data, array $siswaIds = []): BimbinganKelompok
    {
        ...
        if (empty($data['kasus_id'])) {
            // Buat kasus BK baru jika belum dibuat oleh handler.
        ...
        return $record->fresh(['kasus.guruBk.user', 'kasus.tahunAjaran', 'siswa.siswa.user']);
    }
    ...
    public function getFiltered(array $filters = []): Collection
    {
        ...
        if (! empty($filters['jenis_kelamin'])) {
            $query->whereHas('siswa.siswa.user', fn ($q) => $q->where('jenis_kelamin', $filters['jenis_kelamin']));
        }
