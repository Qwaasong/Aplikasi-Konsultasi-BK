...
use App\Models\Dcm;
use App\Repositories\Contracts\DcmRepositoryInterface;
...
class DcmRepository implements DcmRepositoryInterface
{
    ...
    {
        return Dcm::with(['siswa.user', 'siswa.kelas.jurusan'])->latest()->get();
    }

    public function findById(int $id): ?Dcm
    {
        return Dcm::with(['siswa.user', 'siswa.kelas.jurusan'])->find($id);
    }
