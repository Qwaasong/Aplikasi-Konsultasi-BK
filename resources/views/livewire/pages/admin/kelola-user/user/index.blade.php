...
use App\Livewire\Admin\KelolaUser\User\Index;
use Livewire\Attributes\Layout;

new #[Layout('layouts.app', ['title' => 'Kelola User'])] class extends Index {}; ?>
...
<div class="flex-1 flex flex-col min-w-0 bg-white h-full">
    ...
    <x-organisms.data-table empty="Belum ada data user.">
        @foreach($records as $user)
            <tr wire:key="user-{{ $user->id }}" class="group border-b border-gray-100 bg-white transition-all duration-200 h-12 relative
                ...
                <td class="px-4 py-2 w-1/3 align-middle">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-8 h-8 rounded-full bg-icon-bg text-primary flex items-center justify-center font-bold text-xs shrink-0">
