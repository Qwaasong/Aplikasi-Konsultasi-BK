...
new #[Layout('layouts.app', ['title' => 'Rekap Absensi Siswa'])] class extends Index {};
...
<div class="flex-1 flex flex-col min-w-0 bg-white h-full">
    ...
    <header class="h-20 border-b border-gray-200 px-8 flex items-center justify-between shrink-0">
        ...
        @else
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Rekap Absensi</h2>
        @endif
        ...
        <div class="px-6 sm:px-8 py-6">
            ...
            <div class="mb-5">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Pilih kelas untuk melihat rekap kehadiran siswa.
                </p>
    ...
    @else
        ...
        <div class="px-6 sm:px-8 py-5 border-b border-gray-100">
            ...
            <div>
                ...
                <h2 class="text-lg font-semibold text-gray-800">
                    Rekap Absensi {{ $selectedKelas }}
                </h2>

                <p class="text-xs text-gray-500 mt-1">
                    Rekap kehadiran siswa pada kelas {{ $selectedKelas }}.
                </p>
        ...
        >
            ...
            @forelse($records as $record)
                ...
                <tr
                    wire:key="rekap-absensi-{{ $record['id'] }}"
    ...
    <livewire:partials.admin.absensi.absensi-modal />
