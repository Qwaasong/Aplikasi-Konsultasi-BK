...
new #[Layout('layouts.app', ['title' => 'Asesmen AKPD - Bimbingan Konseling'])] class extends Index {};
...
<div>
    ...
    @elseif(!$selectedKelas)
        ...
        <div class="px-6 sm:px-8 py-6">
            ...
            <div class="mb-5">
                ...
                <p class="text-sm text-gray-500 mt-1">Pilih kelas untuk melihat data AKPD tingkat {{ $selectedTingkat }}.</p>
            </div>
    ...
    <x-organisms.data-table
        :headers="[
            ...
            empty="Belum ada data AKPD untuk kelas {{ $selectedKelas }}.">
