...
<div>
    ...
    @if($showFilters)
        ...
        <div class="px-6 sm:px-8 py-3 border-b border-gray-100
            ...
            @if(
                ...
                <button wire:click="resetFilters" class="text-xs text-brand-teal font-medium hover:underline ml-auto">
                    Reset Semua
                </button>
            @endif
        </div>
    ...
    <x-organisms.data-table
        :headers="['','Tanggal','Siswa','Bakat','Minat','Bidang Rekomendasi','Kesimpulan','Aksi']"
        empty="Belum ada data tes bakat minat.">

        @forelse($records as $record)
            <tr

                wire:key="tes-bakat-minat-{{ $record->id }}" wire:click="goToDetail({{ $record->id }})"
