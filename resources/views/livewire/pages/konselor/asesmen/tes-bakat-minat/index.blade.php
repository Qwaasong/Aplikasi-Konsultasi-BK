...
new #[Layout('layouts.app', ['title' => 'Asesmen Bakat Minat - Bimbingan Konseling'])] class extends Index {};
        ...
        <div class="px-6 sm:px-8 py-6">
            ...
            <div class="mb-5">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Pilih tingkat kelas untuk melihat data Tes Bakat Minat.
                </p>
        ...
        @forelse($records as $record)
            ...
            >
                ...
                <td class="px-4 py-2 font-semibold align-middle">
                    ...
                    <a
                        href="{{ route('konselor.asesmen.tes-bakat-minat.detail', $record->id) }}"
                        wire:navigate
                ...
                >
                    ...
                    <div class="flex items-center justify-end gap-2">
                        ...
                        <x-atoms.action-button
                            color="blue"
                            title="Edit"
                            wire:click="loadPeminatan({{ $record->id }})"
                        >
            ...
            <div class="flex flex-col">
                ...
                <div class="px-6 py-5 space-y-4">
                    <div class="bg-blue-50 border border-blue-100 rounded-lg p-3 text-xs text-blue-700">
                        ...
                        <code class="block">nis | tanggal | hasil | linguistik | logis_matematik | visual_spasial | musikal | interpersonal | intrapersonal | kinestetik | naturalis</code>
                        <p class="mt-1 text-blue-500">Kolom bagian diisi jawaban bebas (teks). NIS + tanggal adalah kunci; import ulang akan memperbarui data yang sama.</p>
                    </div>
