            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                @foreach(['X', 'XI', 'XII'] as $tingkat)
                    ...
                    <button
                        ...
                        class="group w-full text-left bg-white border border-gray-200 rounded-xl p-6
    ...
    @elseif(!$selectedKelas)
        ...
        <div class="px-6 sm:px-8 py-6">
            ...
            <div class="mb-5">
                ...
                <p class="text-sm text-gray-500 mt-1">Pilih kelas untuk melihat data Gaya Belajar tingkat {{ $selectedTingkat }}.</p>
            </div>
            ...
            @if(count($tingkatKelasOptions) > 0)
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    @foreach($tingkatKelasOptions as $kelas)
                        <button
                            type="button"
                            wire:key="gaya-belajar-kelas-{{ $kelas }}"
