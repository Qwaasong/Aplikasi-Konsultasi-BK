...
new #[Layout('layouts.app')] class extends Component {
    ...
    public function with(): array
    {
        ...
        if ($this->search) {
            ...
            $data = $data->filter(function ($item) use ($needle) {
                return mb_stripos($item->siswa?->nama ?? '', $needle) !== false
    ...
    public function create() { $this->dispatch('create-pengunduran-diri'); }
    ...
    public function edit($id) { $this->dispatch('edit-pengunduran-diri', id: (int) $id); }
...
<div class="flex-1 flex flex-col min-w-0 bg-white h-full" x-data="{ loading: false }"
    ...
    <x-organisms.data-table
        :headers="['', 'Tanggal', 'Siswa', 'Kelas', 'Orang Tua / Wali', 'Alasan', 'Aksi']"
